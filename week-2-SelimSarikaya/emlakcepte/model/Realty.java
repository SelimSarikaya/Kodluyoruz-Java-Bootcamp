...
public class Realty {
	...
	public Realty(Long no, String title, LocalDateTime publishedDate, User user, RealtyType status, String province,
			String district) {
		super();
		this.no = no;
		this.title = title;
	...
	public RealtyState getState() {
		return state;
	}


	public void setState(RealtyState state) {
		this.state = state;
	}
